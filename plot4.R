...
# Plot 4
	...
	plot(epc$DateTime, epc$Voltage, type="o", pch=21, cex=0, xlab="", ylab="Voltage")
	plot(epc$Sub_metering_1 ~ epc$DateTime , type="o", pch=21, cex=0, xlab="", ylab="")
	...
	plot(epc$DateTime, epc$Global_reactive_power, type="o", pch=21, cex=0, xlab="", ylab="Global_reactive_power")
